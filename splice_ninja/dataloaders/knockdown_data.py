...
class KnockdownData(LightningDataModule):
    def prepare_data(self):
        ...
        if (
            ...
            print(
                f"Number of events of each type after dropping events with no valid measurements: {inclusion_levels_full['COMPLEX'].value_counts()}"
            )
        ...
        if (
            ...
            for i, row in tqdm(
                ...
                if event_type == "EX":
                    ...
                    # TODO
                    raise NotImplementedError("ALTD event type not implemented yet")
