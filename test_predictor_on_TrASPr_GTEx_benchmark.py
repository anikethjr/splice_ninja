...
from splice_ninja.dataloaders.TrASPr_GTEx_benchmark_data import TrASPrGTExBenchmarkData
...
def main():
    ...
    # setup data module
    data_module = TrASPrGTExBenchmarkData(config)
    ...
    if trainer.global_rank == 0:
        ...
        df = data_module.core_benchmark_data
